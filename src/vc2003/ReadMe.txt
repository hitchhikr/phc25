========================================================================
    WIN32 アプリケーション : phc25 プロジェクトの概要
========================================================================

AppWizard はユーザー用に phc25 アプリケーションを作成しました。  
このファイルには phc25 アプリケーションを構成している
各ファイルの概要が含まれています。
...
phc25.ico
    ...
    このアイコンはメイン リソース ファイル phc25.rc に含まれています。

small.ico
    これはアイコン ファイルです。アプリケーション アイコンの小さいバージョンを含みます (16x16)。
    このアイコンはメイン リソース ファイル phc25.rc 
    に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダー (PCH) ファイル phc25.pch、
